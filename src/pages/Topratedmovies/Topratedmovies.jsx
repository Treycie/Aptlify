...
const Topratedmovies = () => {
  ...
  const fetchMovies = () => {
    ...
    fetch(
      "https://api.themoviedb.org/3/movie/top_rated?api_key=fc39126ceb1440435e56fd80d45edb04"
    )
...
//       <div className="bg-black">
//         <h1
//           className="text-white text-center text-3xl my-4 padding-top: 3px
// padding-bottom: 3px "
//         >
//           Top Rated Movies
//         </h1>
...
//     <h1 className="text-white text-center text-3xl my-4">Top Rated Movies</h1>
//     <div className="flex flex-wrap justify-center">
...
//               alt={movie.title}
//               className="rounded-lg transition-all 2s hover:scale-105 hover:brightness-75"
//             />
